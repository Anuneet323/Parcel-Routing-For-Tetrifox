        ...
        <div className="flex shrink-0 items-center gap-2">
          {username ? (
            <div className="flex items-center gap-2.5">
              <span className="hidden sm:inline-flex font-mono text-[10px] text-mute uppercase bg-bone px-2.5 py-1 rounded-full border border-hairline">
                operator: {username}
              </span>
              <button
                type="button"
                onClick={onLogout}
                className="btn btn-outline min-h-9! h-9! px-3.5! py-1.5! text-xs font-semibold"
              >
                Sign Out
              </button>
            </div>
